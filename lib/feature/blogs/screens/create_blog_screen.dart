...
class _CreateBlogScreenState extends State<CreateBlogScreen> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      showDialog(
        ...
        if (store.draftId.isEmpty) {
          store.creatingBlogDoc = true;
          await store.createBlog(
            store.model!,
  ...
  void dispose() {
    ...
    store.disposeCreateArticleVariables();
    super.dispose();
  }
    ...
    return Scaffold(
      body: Stack(
        children: [
                  ...
                  children: [
                    ...
                    HtmlEditor(
                      ...
                      htmlToolbarOptions: HtmlToolbarOptions(
                        ...
                        // dropdownBackgroundColor: AppColors.darkPurple,
          ...
          Observer(builder: (_) {
            if (store.makeBlogPublished ||
                store.uploadingImages ||
                store.creatingBlogDoc) {
              return WillPopScope(
                onWillPop: () async {
                  return false;
                },
